...
class menu(Action):
    def name(self) -> Text:
        return "action_documentos_escolares"

    def run(self, dispatcher: CollectingDispatcher,
            tracker: Tracker,
            domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        dispatcher.utter_message(text='''
- Atestado de matrícula e certidões diversas – 5 dias úteis
- Histórico escolar – 10 dias úteis
- 2ª via da carteirinha de estudante – R$ 15,00* – 15 dias úteis
- Conteúdo Programático – R$ 0,10* folha – 15 dias úteis
- Inscrição de candidatos de outras IES para vagas remanescentes – R$ 20,00*
''')
